...
if __name__ ==  '__main__':
    ...
    if use_cuda == True: 
        ...
        args = Namespace(d=2, r='amygdala',w = 25,epochs = 30,lr = 0.0001, 
    ...
    nucthresh = {'C' : 4,'B' :10,'AB' : 9,'L' : 5}

    if len(nucinds) < nucthresh[args.nuclei]:
        print('Not enough cells. Exiting program.')
        sys.exit(0)
    else: 
        nucinds = nucinds[rand.permutation(len(nucinds))[:nucthresh[args.nuclei]]]
    ...
    with open(args.csv, 'a', encoding='UTF8', newline='') as f:
        ...
        writer.writerow([sessdate, args.d, args.r, args.raw, args.nuclei, nucinds, args.scaler, args.w, 
                         ...
                         100*acc, 100*touchacc, 100*puffacc, dur])
